        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Robson" />
              </Input.Root>

              <Input.Root>
                <Input.Control defaultValue="Natanael" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="dev@robsonnatanael.com.br"
              >
              </Input.Control>
            </Input.Root>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label htmlFor="photo" className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500">
